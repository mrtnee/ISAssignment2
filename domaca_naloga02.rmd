...
Before training our model, we have to find features (words) that are in both training and test data. We will only use the 50 most frequent terms in our term document matrix as we have found out that it works best. Higher number of features not only means more training time, but it also decreases accuracy
```{r}
...
possible_methods = c("knn", "naive_bayes", "LogitBoost")
# possible_methods = c("svmLinearWeights")
